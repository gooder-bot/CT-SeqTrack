...
2026-09-22。本文记录 v31 精简时的恢复对象；当前活动树已原位升级 v32，新增 `32_*` 配置与独立参考，见 [B0修复记录](B0_V32_REPAIR.md)。下文的“当前v31/四份配置”均指精简完成时的历史快照。旧源码、配置、工具与说明不另建归档目录。主要恢复提交为 **`64ad0560bd3037956370a92ee58e95f79e1ebb55`**（下文简称`64ad056`）。本次清理前含未提交状态的完整只读副本为 `artifacts/ct_checks/20260922_v31_slimming/before/`。
