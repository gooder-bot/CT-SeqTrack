...
![A1 time encoding curves](../figures/line_charts/a1_time_encoding_curves.png)

![A1 time encoding best/final](../figures/bar_charts/a1_time_encoding_best_final_summary.png)
...
- `../data/a1_time_encoding_metrics_points.csv`: epoch-level scalar points.
- `../data/a1_time_encoding_metrics_summary.csv`: final/best/mean/std summary.
- `../figures/line_charts/a1_time_encoding_curves.png`: success and precision curves.
- `a1_time_encoding_success_curve.png`: success-only curve.
- `a1_time_encoding_precision_curve.png`: precision-only curve.
- `../figures/bar_charts/a1_time_encoding_best_final_summary.png`: final/best bar chart.
