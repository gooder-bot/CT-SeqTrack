...
- `../figures/line_charts/cand1_disp_dynamics_curves.png`
- `../figures/cand1_disp_dynamics_success_curve.png`
- `../figures/cand1_disp_dynamics_precision_curve.png`
- `../figures/bar_charts/cand1_disp_dynamics_best_final_summary.png`
- `../data/cand1_disp_dynamics_metrics_points.csv`
- `../data/cand1_disp_dynamics_metrics_summary.csv`
