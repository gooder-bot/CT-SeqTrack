...
Validation points are plotted at epochs 5, 10, ..., 60. Baseline values are reused from `../data/metrics_points.csv`; A1/A2 scaled values are extracted from TensorBoard event files under `output/`.
...
## Data files
- `../data/scaled_a1_a2_baseline_metrics_points.csv`
- `../data/scaled_a1_a2_baseline_metrics_summary.csv`
