...
![curves](../figures/line_charts/ablation_a1_a2_curves.png)

![success](../figures/ablation_a1_a2_success_curve.png)

![precision](../figures/ablation_a1_a2_precision_curve.png)

![best final](../figures/bar_charts/ablation_a1_a2_best_final_summary.png)

## Files

- `../data/ablation_a1_a2_metrics_points.csv`
- `../data/ablation_a1_a2_metrics_summary.csv`