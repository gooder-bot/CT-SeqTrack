...
![success/test](../figures/success_test_curve.png)

![precision/test](../figures/precision_test_curve.png)

![combined curves](../figures/success_precision_curves.png)

![best and final summary](../figures/best_final_summary.png)

## Files

- `../data/metrics_points.csv`: tidy per-validation-point data.

- `../data/metrics_summary.csv`: final/best summary.
