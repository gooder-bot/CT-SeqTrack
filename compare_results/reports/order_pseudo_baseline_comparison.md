...
Validation points are plotted at epochs 5, 10, ..., 60. Baseline and A1-pseudo are reused from `../data/a1_time_encoding_metrics_points.csv`; A1-order and A2-order-dyn are extracted from TensorBoard event files under `output/`.
...
## Figures
- `../figures/line_charts/order_pseudo_baseline_curves.png`
- `../figures/order_pseudo_baseline_success_curve.png`
- `../figures/order_pseudo_baseline_precision_curve.png`
- `../figures/bar_charts/order_pseudo_baseline_best_final_summary.png`

## Data files
- `../data/order_pseudo_baseline_metrics_points.csv`
- `../data/order_pseudo_baseline_metrics_summary.csv`
